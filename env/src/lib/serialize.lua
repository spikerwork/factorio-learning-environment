...
global.utils.serialize_entity = function(entity)
    ...
    --        y = y + 1
    --    end
    --    --create_beam_point_with_direction(game.agent_characters[1], entity.direction , {x = x, y = y})
    ...
    if entity.name == "lab" then
        if game.agent_characters[1].force.current_research ~= nil then
            serialized.research = game.agent_characters[1].force.current_research.name
        else
