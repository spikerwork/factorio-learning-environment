...
After each step the throughput of the factory is evaluated during 60 seconds of worktime and the results are supplied to you in the response. Iteratively expand your factory, i.e first make a small factory and then expand the factory in subsequent steps .
"""
    ...
    def verify(self, score: float, instance: FactorioInstance, step_statistics: Dict) -> TaskResponse:
        ...
        return TaskResponse(success = False,
                            meta = {"achievements": max_achievements,
                                    "nr_of_steps_left": self.trajectory_length - step_statistics["current_step_id"]})
